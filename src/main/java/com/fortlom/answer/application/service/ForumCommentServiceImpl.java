...
public class ForumCommentServiceImpl implements ForumCommentService {
    ...
    public List<ForumComment> getAll() {
        ...
        for(ForumComment forumComment:forumComments){
            Forum forum=restTemplate.getForObject("http://localhost:8083/api/v1/forumservice/forums/"+forumComment.getForumCommentid(),Forum.class);
    ...
    public ForumComment create(Long userId, Long forumId, ForumComment request) {
        ...
        Forum forum=restTemplate.getForObject("http://localhost:8083/api/v1/forumservice/forums/"+request.getForumCommentid(),Forum.class);
